...
sound_Rec()
filename = "file.wav" # recorded audio using the microphone
model = keras.models.load_model(r"C:\Users\hpmsi\Downloads\output-20220411T164542Z-001\model.h5") #location of the trained model saved
